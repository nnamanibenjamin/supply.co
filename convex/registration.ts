...
// Register hospital account (called after user signin)
...
// Register supplier account (called after user signin)
...
// Register hospital staff account (called after user signin)
